...
class Encoder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "video_id", "duration", "frames_to_encode", "fps", "res_width", "res_height",
                                         "input_file_title", "encoder", "encoder_type", "bit_rate", "yuv_format", "encoder_mode",
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of Encoder from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of Encoder from a dict"""
        if obj is None:
            return None
