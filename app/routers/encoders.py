...
async def delete_encoder(id: StrictInt = Path(..., description=""), ) -> Encoder:
...
async def get_encoder(id: StrictInt = Path(..., description=""), ) -> Encoder:
...
async def get_encoders() -> List[Encoder]:
...
async def update_encoder(id: StrictInt = Path(..., description=""), encoder_input: Annotated[
    Optional[EncoderInput], Field(description="Encoder object to be added to the store")] = Body(None,
                                                                                                 description="Encoder object to be added to the store"), ) -> None:
